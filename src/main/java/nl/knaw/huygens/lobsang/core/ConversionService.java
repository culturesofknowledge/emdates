...
public class ConversionService {
  ...
  public Optional<YearMonthDay> convert(CalendarPeriod calendarPeriod, YearMonthDay date, String calendar) {
    ...
    final int requestDate = requestConverter.toJulianDay(date);
  ...
  public YearMonthDay defaultConversion(YearMonthDay date, String targetCalendar) {
    final int defaultDate = converters.defaultConverter().toJulianDay(date);
    final YearMonthDay result = converters.get(targetCalendar).fromJulianDay(defaultDate);
