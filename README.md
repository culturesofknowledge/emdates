...
Access to the tool for individual and bulk conversions will also be provided via an open [Timbuctoo][3] API. The addition of an [OpenRefine][17] endpoint for reconciliation of and/or sharing data for this purpose with [GODOT][15] is also under consideration.
